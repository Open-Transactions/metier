...
ScrollView {
    ...
    property bool alternatingRowColors: true // Alternating colors if enabled.
    property color backgroundColor: "white"                
    property color alternateBackgroundColor: "lightgrey"

    property color activeHighlightColor: "#3cadef"
    ...
    property alias backgoundColor: colorRect.color
    ...
    */
        ...
        */
        ...
        Component {
            ...
            FocusScope {
                ...
                //EDIT
                readonly property color itemTextColor: itemSelected ? "blue" : root.textColor
                ...
                Row {
                    ...
                    Repeater {
                        id: itemDelegateRepeater
                        model: columnModel

                        delegate: __itemDelegateLoader

                        onItemAdded: {
                            // TODO:  Qt5 seems ok, Qt6 complains about this:
                            // Parameter "index" is not declared. Injection of parameters into signal handlers is 
                            // deprecated. Use JavaScript functions with formal parameters instead.
                            var item_index = index
                            var item_data = item
                            var columnItem = columnModel.get(item_index).columnItem
                            item_data.__rowItem = rowitem
                            item_data.__column = columnItem
                        }
                        // debugger:
                        //Component.onCompleted: {
                        //    console.log("debugger: TreeView", model)
                        //    QML_Debugger.listEverything(itemDelegateRepeater)
                        //}
                    }
                }
            }
                ...
                Repeater {
                    ...
                    delegate: Item {
                        ...
                        Rectangle{
                            ...
                            color: root.activeHighlightColor
    ...
    __itemDelegateLoader: Loader {
            ...
            property QtObject styleData: QtObject {
                ...
                readonly property color textColor: __rowItem ? __rowItem.itemTextColor : root.textColor
            ...
            Loader {
                ...
                sourceComponent: Item {
                        ...
                        // The indicator for a drop down element is defined here:
                        Text {
