...
#include "metier/skins/metier/widget/mainwindow.hpp"  // IWYU pragma: associated
...
#include "metier/skins/metier/widget/mainwindow/chaintoolboxmanager.hpp"
#include "metier/skins/metier/widget/mainwindow/imp.hpp"
#include "metier/skins/metier/widget/seedmanager.hpp"
#include "metier/skins/metier/widget/showseed.hpp"

namespace metier::skins::metier::widget
{
using OTModel = opentxs::ui::AccountListQt;

MainWindow::MainWindow(QObject* parent, common::Api& ot) noexcept
    : QMainWindow(nullptr)
    ...
    , imp_(*imp_p_)
{
    ...
    connect(
        &ot,
        &common::Api::privateReadyForMainWindow,
        this,
        &MainWindow::updateToolbox);
    connect(&ot, &common::Api::chainsChanged, this, &MainWindow::updateToolbox);
    ...
    connect(bcdone, &QPushButton::clicked, &ot, &common::Api::checkAccounts);
...
auto MainWindow::showRecoveryWords() -> void
{
    ...
    auto postcondition = common::ScopeGuard{[&]() { dialog.release(); }};
