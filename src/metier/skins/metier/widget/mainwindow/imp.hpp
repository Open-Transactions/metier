...
#include "metier/skins/metier/widget/addcontact.hpp"
...
#include "metier/skins/metier/widget/mainwindow/syncprogress.hpp"
...
struct MainWindow::Imp {
    ...
    Imp(MainWindow* parent, common::Api& ot) noexcept
        : parent_(*parent)
        , ot_(ot)
              ...
              [this](const auto chain) { register_progress(chain); })
    {
        ...
        connect(&parent_, &QObject::destroyed, &ot_, &common::Api::quit);
    }
