...
struct EnterPassphrase::Imp {
    ...
    auto passphraseChanged() noexcept -> void
    {
        ...
        valid_retype_ = run_one_or_two_ ? true : (0 == retype_.compare(passphrase_));
        check_ok(lock);
    }
    ...
    Imp(EnterPassphrase* parent, const QString& displayString, bool runOneOrTwo) noexcept
        ...
        , retype_("")
    {
        ...
        passphrase->setStyleSheet(QLatin1String("lineedit-password-character: 9679"));
...
private:
    ...
    {
        return valid_retype_ && !canceled_;
    }
